...
declare module "express" {
    ...
    // Added by Koh
    export function (): express.ExpressServer; // hack for express 3.x
    export function basicAuth(name: string, password: string): void;

    export function createServer(): ExpressServer;
    export function cookieParser();
    export function session(option?: any): any;
   ...
   // Connect middleware
    ...
    export interface ExpressServer {
        ...
        get(path: string, middleware:any, callbacks: any): void;
